-- DS 移植版：移除 BrainCommon.PanicTrigger/ElectricFencePanicTrigger
-- caveventmitebrain.lua — 地热螨 AI
...
function CaveVentMiteBrain:OnStart()
    local root = PriorityNode({
        ...
        -- DS 移植：移除 PanicTrigger / ElectricFencePanicTrigger（DST BrainCommon 独有）

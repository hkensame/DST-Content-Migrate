local ComplexProjectile2 = Class(function(self, inst)
	self.inst = inst
...
function ComplexProjectile2:GetDebugString()
	return tostring(self.velocity)
end

function ComplexProjectile2:SetHorizontalSpeed(speed)
    self.horizontalSpeed = speed
end

function ComplexProjectile2:SetGravity(g)
    self.gravity = g
end

function ComplexProjectile2:SetLaunchOffset(offset)
    self.launchoffset = offset -- x is facing, y is height, z is ignored
end

function ComplexProjectile2:SetOnLaunch(fn)
	self.onlaunchfn = fn
end

function ComplexProjectile2:SetOnHit(fn)
	self.onhitfn = fn
end

function ComplexProjectile2:GetHorizontalSpeed(distance)
	return self.horizontalSpeed or Lerp(3, 12, distance/self.maxRange)
end

function ComplexProjectile2:GetVerticalVelocity(distance)
	return ((self.gravity * distance)/2)/self:GetHorizontalSpeed(distance)
end

function ComplexProjectile2:CalculateTrajectory(startPos, endPos, speed)
...
function ComplexProjectile2:Launch(targetPos, attacker)
...
function ComplexProjectile2:Hit(target)
...
function ComplexProjectile2:OnUpdate(dt)

...
require "stategraphs/SGdeerclops_yule"
...
local function fn(Sim)
    ...
    ------------------------------------------
  if TUNING.WINTERS_FEAST then
    inst:SetStateGraph("SGdeerclops_yule")
  else
    ...
    inst.components.health:SetMaxHealth((TUNING.WINTERS_FEAST and 4000 ) or TUNING.DEERCLOPS_HEALTH) --2000

    ------------------
    inst:AddComponent("combat")
    inst.components.combat:SetDefaultDamage(TUNING.DEERCLOPS_DAMAGE) --150
    inst.components.combat.playerdamagepercent = 0.5 --TUNING.DEERCLOPS_DAMAGE_PLAYER_PERCENT
    inst.components.combat:SetRange((TUNING.WINTERS_FEAST and 8 ) or TUNING.DEERCLOPS_ATTACK_RANGE) --6
    inst.components.combat:SetAreaDamage(TUNING.DEERCLOPS_AOE_RANGE, TUNING.DEERCLOPS_AOE_SCALE) --6, 0.8
    inst.components.combat.hiteffectsymbol = "deerclops_body"
    inst.components.combat:SetAttackPeriod((TUNING.WINTERS_FEAST and 4 ) or TUNING.DEERCLOPS_ATTACK_PERIOD) --3

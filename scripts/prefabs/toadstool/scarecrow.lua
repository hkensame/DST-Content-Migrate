...
local assets =
{
    ...
    Asset("ANIM", "anim/toadstool/swap_scarecrow_face.zip"),
...
local function onburnt(inst)
    ...
    if inst.components.playeravatardata ~= nil then
...
STRINGS.NAMES.SCARECROW = "Friendly Scarecrow"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SCARECROW = {}
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SCARECROW.BURNING = "Someone made that strawman eat crow."
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SCARECROW.BURNT = "Someone MURDERed that scarecrow!"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.SCARECROW.GENERIC = "All dressed up and no where to crow."
STRINGS.RECIPE_DESC.SCARECROW ="Models all the latest fall fashions."

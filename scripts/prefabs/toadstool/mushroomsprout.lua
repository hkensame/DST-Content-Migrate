...
local function MakeSprout(name)
    local assets =
    {
        Asset("ANIM", "anim/toadstool/mushroomsprout.zip"),
        Asset("ANIM", "anim/toadstool/"..name.."_upg_build.zip"),
    }
    ...
    local function fn()
        ...
        inst._fade = 0 --net_smallbyte(inst.GUID, "mushroomsprout._fade", "fadedirty")
        ...
        --MakeHauntableWorkAndIgnite(inst) -- DS 无 hauntable

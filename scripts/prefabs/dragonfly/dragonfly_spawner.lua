...
local function OnKilled(inst)
    inst.components.timer:StartTimer("regen_dragonfly", TUNING.DRAGONFLY2_RESPAWN_TIME or 480*20)--480*20
end
...
local function fn()
    ...
    inst.components.childspawner.childname = "dragonfly2"
    inst.components.childspawner:SetMaxChildren(1)
    inst.components.childspawner:SetSpawnPeriod(TUNING.DRAGONFLY2_SPAWN_TIME or 1, 0)

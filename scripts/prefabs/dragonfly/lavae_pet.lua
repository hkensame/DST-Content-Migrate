...
local assets =
{
    Asset("ANIM", "anim/dragonfly/lavae.zip"),
...
-- end
 ...
 local function OnGetItemFromPlayer(inst,giver)
if giver == GetPlayer() then
...
local function fn()
 ...
 --   inst.entity:AddNetwork()
    ...
    inst.components.hunger:SetRate(50/480)

    inst.components.inventory.maxslots = 2

    inst.components.eater.foodprefs = {}
    inst.components.eater.ablefoods = {}
    table.insert(inst.components.eater.foodprefs, "BURNT")
	table.insert(inst.components.eater.ablefoods, "BURNT")

-- 猴子图腾柱 (monkeypillar)
-- 移植自 DST，适配 DS 单机模式
-- 移除：AddNetwork, SetPristine, ismastersim, OnEntitySleep/OnEntityWake
-- 适配：注释 MakeSnowCoveredPristine/MakeSnowCovered, POPULATING→rawget
...
local function fn()
    ...
    --MakeSnowCoveredPristine(inst) -- DS 无雪系统

...
-- cookpot common callbacks (from DST cookpot.lua)
...
local function getstatus(inst)
    return (inst:HasTag("burnt") and "BURNT")
        or (inst.components.stewer.done and "DONE")
        or (not inst.components.stewer.cooking and "EMPTY")
...
-- archive_cookpot specific postinits
local function archive_common(inst)
    inst.AnimState:SetBank("cook_pot")
    inst.AnimState:SetBuild("cookpot_archive")
    inst.AnimState:PlayAnimation("idle_empty")
    inst.MiniMapEntity:SetIcon("cookpot_archive.tex")
end
...
local function archive_master(inst)
...
-- Main prefab function (inlined MakeCookPot for archive_cookpot)
local function fn()
    ...
    -- Master side (DS is always master sim)
...
return Prefab("archive_cookpot", fn, assets, prefabs)

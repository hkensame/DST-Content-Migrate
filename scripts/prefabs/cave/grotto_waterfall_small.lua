-- DS 适配版 grotto_waterfall_small.lua
-- 从 DST 源码 scripts/prefabs/grotto_waterfall_small.lua 移植
-- 改动：
...
local prefabs =
{
    -- 🔴 halloween_moonpuff 移除（缺少动画资源）
}

-- 注意：moonglass_prop 共享战利品表已在 grotto_pool_moonglass.lua 中定义
-- 此处复用，不再重复 SetSharedLootTable

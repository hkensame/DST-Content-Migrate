...
local MED_THRESHOLD_UP = 0.66
local LOW_THRESHOLD_UP = 0.33
local BOTTOM_THRESHOLD = 0.2
...
local function OnAttackedHusk(inst)
...
local function huskfn()
    ...
    inst:ListenForEvent("attacked", OnAttackedHusk)

...
local function mainfn()
	...
	-- DS 没有 DEPLOYSPACING_RADIUS/SetDeploySmartRadius
    ...
    -- DS: no SetPristine, no ismastersim early return
...
local function itemfn()
    ...
    inst.components.inventoryitem.atlasname = "images/archive_resonator.xml"
    inst.components.inventoryitem.imagename = "archive_resonator"
    inst.components.inventoryitem:SetSinks(true)

    -- DS: no MakeHauntableLaunch

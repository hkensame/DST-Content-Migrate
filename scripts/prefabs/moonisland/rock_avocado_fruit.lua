...
{
    Asset("ANIM", "anim/moonisland/rock_avocado_fruit.zip"),
    Asset("ANIM", "anim/moonisland/rock_avocado_fruit_build.zip"),
...
local function rock_avocado_fruit_full()
    ...
    inst.components.inventoryitem.imagename = "rock_avocado_fruit_rockhard"
...
local function rock_avocado_fruit_ripe()
    ...
    if rawget(_G, 'MakeInventoryFloatable') then
        MakeInventoryFloatable(inst, "idle_split_open", "idle_split_open")
    end
    ...
    inst.components.inventoryitem.imagename = "rock_avocado_fruit_ripe"
    inst.components.inventoryitem.atlasname = "images/dst_boss.xml"
...
local function rock_avocado_fruit_ripe_cooked()
    ...
    inst.components.inventoryitem.imagename = "rock_avocado_fruit_ripe_cooked"
    inst.components.inventoryitem.atlasname = "images/dst_boss.xml"
...
local function rock_avocado_fruit_sprout_sapling()
    ...
    inst.MiniMapEntity:SetIcon("rock_avocado.tex")
...
local function rock_avocado_fruit_sprout()
    ...
    if rawget(_G, 'MakeInventoryFloatable') then
        MakeInventoryFloatable(inst, "idle_seed", "idle_seed") --(inst, "small", nil, 0.4)
    end
    ...
    inst.components.inventoryitem.imagename = "rock_avocado_fruit_sprout"
    inst.components.inventoryitem.atlasname = "images/dst_boss.xml"

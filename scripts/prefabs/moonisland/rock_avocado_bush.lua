local assets =
{
    Asset("ANIM", "anim/moonisland/rock_avocado.zip"),
    Asset("ANIM", "anim/moonisland/rock_avocado_build.zip"),
    Asset("PKGREF", "anim/moonisland/rock_avocado_diseased_build.zip"),
...
local function on_dug_up(inst, digger)
    ...
    local withered = inst.components.pickable ~= nil and inst.components.pickable:IsWithered()

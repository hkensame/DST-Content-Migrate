...
local assets=
{
	Asset("ANIM", "anim/moonisland/oceanvine.zip"),
...
local function fall(inst)
    ...
    local onland = inst:IsOnValidGround() --TheWorld.Map:IsVisualGroundAtPoint(point.x,point.y,point.z) or TheWorld.Map:GetPlatformAtPoint(point.x,point.z) 
    if onland then
...
local function commonfn(Sim)
    ...
    inst.MiniMapEntity:SetIcon("oceanvine.tex")
...
--[[
    ...
    -- fig removed, oceanvine product needs reassignment

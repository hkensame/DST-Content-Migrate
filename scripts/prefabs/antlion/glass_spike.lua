local assets =
{
    Asset("ANIM", "anim/antlion/sand_spike.zip"),
    Asset("ANIM", "anim/antlion/swap_glass_spike.zip"),
...
local block_assets =
{
    Asset("ANIM", "anim/antlion/sand_block.zip"),
    Asset("ANIM", "anim/moonisland/swap_glass_block.zip"),
}
...
local function MakeSpikeFn(shape, size)
    return function()
        ...
        MakeInventoryPhysics(inst, inst.spikeradius)
        ...
        inst.components.inventoryitem.imagename = "glassblock"

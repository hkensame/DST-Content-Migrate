...
SetSharedLootTable("bishop_nightmare_spawner",
{
    {"nightmarefuel",    1.00},
...
local function fn()
    ...
    inst.components.lootdropper:SetChanceLootTable("bishop_nightmare_spawner")

    return inst
end

return Prefab("bishop_nightmare_spawner", fn, assets, prefabs)

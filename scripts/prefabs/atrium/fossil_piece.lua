...
local assets =
{
    Asset("ANIM", "anim/atrium/fossil_piece.zip"),
}
...
local function fn()
    ...
    --inst.components.deployable:SetDeploySpacing(DEPLOYSPACING.LESS) --改，暂时禁用

    inst:AddComponent("repairer")
    --inst.components.repairer.repairmaterial = MATERIALS.FOSSIL
    inst.components.repairer.repairmaterial = "fossil"

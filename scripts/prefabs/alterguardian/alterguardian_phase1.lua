local assets =
{
    Asset("ANIM", "anim/alterguardian/alterguardian_phase1.zip"),
...
local TARGET_DIST = TUNING.ALTERGUARDIAN_PHASE1_TARGET_DIST or 20
...
local HEALTH_GAIN_RATE = (TUNING.ALTERGUARDIAN_PHASE1_HEALTH or 10000) / (TUNING.TOTAL_DAY_TIME or 480) * 5
...
local function fn()
    ...
    -- 改MakeGiantCharacterPhysics(inst, 500, 1.25)：DS 没有该函数，手动设置 GIANTS 碰撞组以支持地形破坏
    do

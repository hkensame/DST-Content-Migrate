local assets =
{
    Asset("ANIM", "anim/alterguardian/alterguardianhatshard.zip"),
    Asset("ANIM", "anim/alterguardian/ui_alterguardianhat_1x1.zip"),
...
local function fn()
    ...
    if rawget(_G, 'MakeInventoryFloatable') then
        MakeInventoryFloatable(inst, "idle", "idle") --"small", 0.07, 0.73)
    end

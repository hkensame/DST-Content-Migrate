    ...
    State{
        ...
        onenter = function(inst, remaining)
            ...
            if inst.sg.statemem.remaining == 0 then
                ...
                local players = shuffleArray(GetClosestInstWithTag("player", inst, TUNING.SHADOWCREATURE_TARGET_DIST))--shuffleArray(FindPlayersInRange(x, y, z, TUNING.SHADOWCREATURE_TARGET_DIST, true))

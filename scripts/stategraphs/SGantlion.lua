...
local function ShakeIfClose(inst)
    ...
    if player then
        player.components.playercontroller:ShakeCamera(inst, "FULL", 0.5, 0.2, .15, SHAKE_DIST)
    end
end
...
local function ShakeCasting(inst)
    local player = GetClosestInstWithTag("player", inst, SHAKE_DIST)
    if player then
        player.components.playercontroller:ShakeCamera(inst, "VERTICAL", 0.3, 0.2, 1, SHAKE_DIST)
    end
end
...
local states =
{
    ...
    State
    {
        ...
        timeline =
        {
            TimeEvent(7 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/taunt") end),
        },
    ...
    State
    {
        ...
        timeline =
        {
            TimeEvent(12 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/eat") end),
            TimeEvent(36 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/eat") end),
    ...
    State
    {
        ...
        timeline =
        {
            TimeEvent(0, function(inst)
                inst.SoundEmitter:PlaySound("antlion/antlion/purr")
    ...
    State
    {
        ...
        timeline =
        {
            ...
            TimeEvent(54 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/unimpressed") end),
        },
    ...
    State
    {
        ...
        timeline =
        {
            ...
            TimeEvent(44 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/unimpressed") end),
            TimeEvent(80 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound("antlion/antlion/spit")
                inst:GiveReward()
            end),
    ...
    State
    {
        ...
        timeline =
        {
            TimeEvent(0 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/enter") end),
        },
    ...
    State
    {
        ...
        timeline =
        {
            TimeEvent(28 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/enter") end),
    ...
    State
    {
        ...
        timeline =
        {
            TimeEvent(8 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/cast_pre") end),
            TimeEvent(25.5 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("antlion/antlion/cast_post") end),
    ...
    State
    {
        ...
        timeline =
        {
            TimeEvent(28 * FRAMES, function(inst)
                ShakeCasting(inst)
                inst.SoundEmitter:PlaySound("antlion/antlion/cast_pre")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("antlion/antlion/hit")
        end,
